...
import com.dragon.superplayer.player.util.ActivityUtil;
import com.dragon.superplayer.player.util.ContextProvider;
        ...
        this.mIPlayControler
                .setPlayControllerCallback(new PlayControllerCallback() {
                    ...
                    public boolean isScreenOrientationLandspace() {
                        return VideoPlayerManager.this.getCurrentScreenStatus() == ScreenStatus.FULLSCREEN;
                    }
                });
    }
